...
analyze -library WORK -format verilog {../src/ram_only.v}
#analyze -library WORK -format verilog {$SRC_FOLDER/TSV.v}
read_file -format verilog {../src/ram_only.v}
...
write -f verilog -h -out   ./output_files/ram_only.vnet
write -f  ddc -h -out       ./output_files/ram_only.ddc
write_sdc       ./output_files/ram_only.sdc
